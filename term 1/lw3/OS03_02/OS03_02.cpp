...
int main()
{
	...
	LPCWSTR OS03_02_1 = L"D:\\FILES\\University\\3 course\\1 term\\OS\\lw3\\x64\\Debug\\OS03_02_1.exe";
	LPCWSTR OS03_02_2 = L"D:\\FILES\\University\\3 course\\1 term\\OS\\lw3\\x64\\Debug\\OS03_02_2.exe";
	STARTUPINFO si1;								// структура для определения внешнего вида окна для нового процесса
	STARTUPINFO si2;								
	...
	if (CreateProcess(	
		OS03_02_1,			// lpApplicationName:	имя исполняемого модуля - exe иди другой тип 
